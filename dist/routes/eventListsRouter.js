...
const eventListsService_1 = require("../domain/eventListsService");
const getEventListsRouter = () => {
    ...
    eventListsRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield eventListsService_1.eventListsService.createEventList(req.body.eventList, req.body.accentColor);
        if (response !== "Error")
            return res.json({
                resultCode: 0,
                data: {
